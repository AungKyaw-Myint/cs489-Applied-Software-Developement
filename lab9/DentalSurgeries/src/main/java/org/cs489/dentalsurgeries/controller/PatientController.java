...
@RestController
@RequestMapping("/api/v1/user/patients")
...
public class PatientController {
    ...
    public ResponseEntity<PatientResponse> updatePatient(@PathVariable("patientId") Long patientId, @RequestBody PatientRequest patientRequest) {
